                        ...
                        <div style={{ padding: '8px 0' }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                {sections.map((section, idx) => {
                                    ...
                                    const isExpanded = activeSectionIndex === idx;
                                    const isEmpty = !section.title && !section.description;
                                    if (isEmpty && !isExpanded) return null;
                                            ...
                                            >
                                                ...
                                                >
                                                    <Button
                                                        ...
                                                        onClick={() => setActiveSectionIndex(isExpanded ? -1 : idx)}
                                                    >
                                                        {isExpanded ? t('createContent.sectionSave') : t('createContent.sectionEdit')}
                                                    </Button>
                                                    <Button
                                                        type="link"
                                                        size="small"
                                                    ...
                                                    <Space direction="vertical" size={16} style={{ width: '100%' }}>
                                                        ...
                                                        <Space wrap>
                                                            <Button
                                                                ...
                                                                icon={<SaveOutlined />}
                                                                onClick={() =>
                                                                    section && handleGenerateSectionContent(section)
                                                                }
                                                                disabled={
                                                                    !section ||
                                                                    !section.title ||
                                                            ...
                                                            <Button
                                                                icon={<RobotOutlined />}
                                                                onClick={() =>
                                                                    section && handleRefreshSectionQueries(section)
                                                                }
                                                                loading={currentSectionQueriesLoading && activeSectionIndex === idx}
                                                                disabled={
                                                                    !section ||
                                                                    !section.title ||
                                                                    section.title.trim().length < 3
                                                            ...
                                                            <Button
                                                                icon={<SearchOutlined />}
                                                                onClick={() =>
                                                                    section && handleFetchNewsForSection(section)
                                                                }
                                                                loading={currentSectionNewsLoading && activeSectionIndex === idx}
                                                                disabled={!section?.id}
                                                            >
                                                        ...
                                                        {(() => {
                                                            ...
                                                            return (
                                                                <>
                                                                    <div style={{ margin: '12px 0 8px', borderTop: '1px solid #e5e7eb', paddingTop: 12 }}>
                                                        ...
                                                        {currentSectionNewsResults.length > 0 && (
                                                            <div style={{ borderTop: '1px solid #e5e7eb', marginTop: 12, paddingTop: 12 }}>
                                                                <Typography.Text strong style={{ fontSize: 13 }}>
                                                                    {t('createContent.sectionSearchNewsGroupTitle', {
                                                                        query: 'Artigos encontrados',
                                                                    })}
                                                                </Typography.Text>
                                                                                            ...
                                                                                            <List.Item.Meta
                                                                                                ...
                                                                                                description={
                                                                                                    <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                                                                                                        ...
                                                                                                        {article.snippet && (
                                                                                                            <Typography.Paragraph style={{ margin: 0, fontSize: 11, color: '#374151' }}>
                                                                                                                {article.snippet.substring(0, 80)}...
