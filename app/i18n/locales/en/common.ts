const common = {
  ...
  createContent: {
    ...
    contentGenerationCard: "Content Generation",
    ...
    newsletterSectionsTitle: "Newsletter Sections:",
    section: "Section",
    ...
    articlesInSection: "Articles in Section",
    removeFromSection: "Remove from section",
    addToActiveSection: "Add to active section",
