const common = {
  ...
  sectionEditorTitle: "Editing Section {{number}}",
  sectionEdit: "Edit",
  sectionRemove: "Remove",
  sectionGenerateContent: "Generate content",
  sectionRegenerateQueries: "Regenerate queries",
  sectionFetchNews: "Fetch news",
  sectionSuggestedQueries: "Suggested queries",
  ...
  linkedin: "LinkedIn",
  save: "Save",
  generateAndSaveNewsletter: "Generate and Save Newsletter",
  ...
  generateTwitterThread: "Generate Twitter Thread",
  resetThread: "Reset Thread",
  copyTweet: "Copy Tweet",
  threadSummaryTitle: "Thread Summary",
